...
Language. (Google Workspace, SSO, SAML respectively).
...
PTN_SIGNED_INFO_XML_WITH_C14N_2 = \
'<ds:SignedInfo xmlns:ds="http://www.w3.org/2000/09/xmldsig#"%(xmlns_attr)s><ds:CanonicalizationMethod Algorithm="http://www.w3.org/2001/10/xml-exc-c14n#"></ds:CanonicalizationMethod><ds:SignatureMethod Algorithm="http://www.w3.org/2000/09/xmldsig#rsa-sha1"></ds:SignatureMethod><ds:Reference URI="%(reference_uri)s"><ds:Transforms><ds:Transform Algorithm="http://www.w3.org/2000/09/xmldsig#enveloped-signature"></ds:Transform><ds:Transform Algorithm="http://www.w3.org/2001/10/xml-exc-c14n#"><ec:InclusiveNamespaces xmlns:ec="http://www.w3.org/2001/10/xml-exc-c14n#" PrefixList="xs"></ec:InclusiveNamespaces></ds:Transform></ds:Transforms><ds:DigestMethod Algorithm="http://www.w3.org/2000/09/xmldsig#sha1"></ds:DigestMethod><ds:DigestValue>%(digest_value)s</ds:DigestValue></ds:Reference></ds:SignedInfo>'
PTN_SIGNED_INFO_XML_2 = \
...
PTN_SIGNATURE_XML_2 = \
'<ds:Signature %(signature_id)sxmlns:ds="http://www.w3.org/2000/09/xmldsig#">%(signed_info_xml)s<ds:SignatureValue>%(signature_value)s</ds:SignatureValue>%(key_info_xml)s</ds:Signature>'

# Pattern Map:
#   modulus: str signing RSA key modulus in base64 
#   exponent: str signing RSA key exponent in base64
PTN_KEY_INFO_RSA_KEY_2 = \
'<ds:KeyInfo><ds:KeyValue><ds:RSAKeyValue><ds:Modulus>%(modulus)s</ds:Modulus><ds:Exponent>%(exponent)s</ds:Exponent></ds:RSAKeyValue></ds:KeyValue></ds:KeyInfo>'

# Pattern Map:
#   cert_b64: str of X509 encryption certificate in base64
#   subject_name_xml: str <X509SubjectName> bytstring xml or ""
PTN_KEY_INFO_X509_CERT_2 = \
'<ds:KeyInfo><ds:X509Data>%(subject_name_xml)s<ds:X509Certificate>%(cert_b64)s</ds:X509Certificate></ds:X509Data></ds:KeyInfo>'

# Pattern Map:both
PTN_KEY_INFO_RSAKEY_AND_X509_CERT_2 = \
'<ds:KeyInfo><ds:X509Data>%(subject_name_xml)s<ds:X509Certificate>%(cert_b64)s</ds:X509Certificate></ds:X509Data><ds:KeyValue><ds:RSAKeyValue><ds:Modulus>%(modulus)s</ds:Modulus><ds:Exponent>%(exponent)s</ds:Exponent></ds:RSAKeyValue></ds:KeyValue></ds:KeyInfo>'

# Pattern Map:
#   subject_name: str of <SubjectName> value
PTN_X509_SUBJECT_NAME_2 = \
'<ds:X509SubjectName>%(subject_name)s</ds:X509SubjectName>'
...
#   digest_value: padded hash of message in base64
PTN_SIGNED_INFO_XML_WITH_C14N_2 = \
'<ds:signedinfo xmlns:ds="http://www.w3.org/2000/09/xmldsig#"><ds:canonicalizationmethod algorithm="http://www.w3.org/2001/10/xml-exc-c14n#"><ds:signaturemethod algorithm="http://www.w3.org/2000/09/xmldsig#rsa-sha1"><ds:reference uri="%(reference_uri)s"><ds:transforms><ds:transform algorithm="http://www.w3.org/2000/09/xmldsig#enveloped-signature"></ds:transform><ds:transform algorithm="http://www.w3.org/2001/10/xml-exc-c14n#"></ds:transform></ds:transforms><ds:digestmethod algorithm="http://www.w3.org/2000/09/xmldsig#sha1"><ds:digestvalue>%(digest_value)s</ds:digestvalue></ds:digestmethod></ds:reference></ds:signaturemethod></ds:canonicalizationmethod></ds:signedinfo>'
PTN_SIGNED_INFO_XML_2 = \
'<ds:signedinfo xmlns:ds="http://www.w3.org/2000/09/xmldsig#"><ds:canonicalizationmethod algorithm="http://www.w3.org/TR/2001/REC-xml-c14n-20010315#WithComments"></ds:canonicalizationmethod><ds:signaturemethod algorithm="http://www.w3.org/2000/09/xmldsig#rsa-sha1"></ds:signaturemethod><ds:reference uri="%(reference_uri)s"><ds:transforms><ds:transform algorithm="http://www.w3.org/2000/09/xmldsig#enveloped-signature"></ds:transform></ds:transforms><ds:digestmethod algorithm="http://www.w3.org/2000/09/xmldsig#sha1"></ds:digestmethod><ds:digestvalue>%(digest_value)s</ds:digestvalue></ds:reference></ds:signedinfo>'
...
#########################################
# NextSet���� ds �� + XML�Ĥ����ʤɤ⸷̩��Glugant�˹�碌����Ρ��������ޤǤ��ɬ�����Фʤ�...

# Pattern Map:
#   xmlns_attr: xml name space definition attributes including ' ' prefix
#   digest_value: padded hash of message in base64
PTN_SIGNED_INFO_XML_WITH_C14N_2 = \
'<ds:SignedInfo xmlns:ds="http://www.w3.org/2000/09/xmldsig#"%(xmlns_attr)s><ds:CanonicalizationMethod Algorithm="http://www.w3.org/2001/10/xml-exc-c14n#" /><ds:SignatureMethod Algorithm="http://www.w3.org/2000/09/xmldsig#rsa-sha1" /><ds:Reference URI="%(reference_uri)s"><ds:Transforms><ds:Transform Algorithm="http://www.w3.org/2000/09/xmldsig#enveloped-signature"/><ds:Transform Algorithm="http://www.w3.org/2001/10/xml-exc-c14n#"/></ds:Transforms><ds:DigestMethod Algorithm="http://www.w3.org/2000/09/xmldsig#sha1"/><ds:DigestValue>%(digest_value)s</ds:DigestValue></ds:Reference></ds:SignedInfo>'
PTN_SIGNED_INFO_XML_2 = \
'<ds:SignedInfo xmlns:ds="http://www.w3.org/2000/09/xmldsig#"%(xmlns_attr)s><ds:CanonicalizationMethod Algorithm="http://www.w3.org/TR/2001/REC-xml-c14n-20010315#WithComments"/><ds:SignatureMethod Algorithm="http://www.w3.org/2000/09/xmldsig#rsa-sha1"/><ds:Reference URI="%(reference_uri)s"><ds:Transforms><ds:Transform Algorithm="http://www.w3.org/2000/09/xmldsig#enveloped-signature"/></ds:Transforms><ds:DigestMethod Algorithm="http://www.w3.org/2000/09/xmldsig#sha1"/><ds:DigestValue>%(digest_value)s</ds:DigestValue></ds:Reference></ds:SignedInfo>'
...
#b64d = lambda s: base64.decodestring(s)
...
def sign(xml, f_private, key_info_xml, key_size, with_c14n=False, reference_uri='', after_issuer=False, sig_id_value=None):
  ...
  """
  signed_info_xml = _signed_info(xml, with_c14n=with_c14n, reference_uri=reference_uri)
...
# ��̾�������򾯤��ѹ��������
def sign2(xml, f_private, key_info_xml, key_size, with_c14n=False, reference_uri='', after_issuer=False, sig_id_value=None):
  """Return xmldsig XML string from xml_string of XML.
  ...
  Returns:
    str: signed bytestring xml
  """
  signed_info_xml = _signed_info2(xml, with_c14n=with_c14n, reference_uri=reference_uri)
  signed = _signed_value(signed_info_xml, key_size)
  signature_value = f_private(signed)
  ...
  signature_xml = PTN_SIGNATURE_XML_2 % {
    'signed_info_xml': signed_info_xml,
    'signature_value': b64e(signature_value),
    'key_info_xml': key_info_xml,
    'signature_id': signature_id,
...
def verify(xml, f_public, key_size, with_c14n=False, reference_uri=''):
  ...
  signed_info_xml = _signed_info(unsigned_xml, with_c14n=with_c14n, reference_uri=reference_uri)
...
def key_info_xml_rsa2(modulus, exponent):
  """Return <KeyInfo> xml bytestring using raw public RSA key.
...
def key_info_xml_cert2(cert_b64, subject_name=None):
  """Return <KeyInfo> xml bytestring using RSA X509 certificate.
  ...
  if subject_name is None:
    ...
    subject_name_xml = PTN_X509_SUBJECT_NAME_2 % {
      'subject_name': subject_name,
      }
  xml = PTN_KEY_INFO_X509_CERT_2 % {
    'cert_b64': cert_b64,
    'subject_name_xml': subject_name_xml,
    }
  return xml
  
def key_info_xml_rsa_and_cert2(modulus, exponent, cert_b64, subject_name=None):
  """Return <KeyInfo> xml bytestring using raw public RSA key and RSA X509 certificate.
  ...
  xml = PTN_KEY_INFO_RSAKEY_AND_X509_CERT_2 % {
    'modulus': b64e(modulus),
    'exponent': b64e(exponent),
    'cert_b64': cert_b64,
    'subject_name_xml': subject_name_xml,
...
def _signed_info(xml, with_c14n=False, reference_uri=''):
  ...
  logging.info(xmlns_attr)

  if with_c14n:
    signed_info_xml = PTN_SIGNED_INFO_XML_WITH_C14N % {
      'xmlns_attr': xmlns_attr,
      'reference_uri': reference_uri,
      'digest_value': b64e(_digest(xml)),
    }

    logging.info(signed_info_xml)
    # �����������
...
def _signed_info2(xml, with_c14n=False, reference_uri=''):
  """Return <SignedInfo> for bytestring xml.
  ...
  if with_c14n:
    signed_info_xml = PTN_SIGNED_INFO_XML_WITH_C14N_2 % {
      'xmlns_attr': xmlns_attr,
      'reference_uri': reference_uri,
      'digest_value': b64e(_digest(xml)),
    }
    ...
    # Signature �Ρ��ɤΤۤ��ˤĤ��Ƥ���Τǡ�JJ��J-Act�����ѡ�
    signed_info_xml = signed_info_xml.replace('<ds:SignedInfo xmlns:ds="http://www.w3.org/2000/09/xmldsig#">', '<ds:SignedInfo>')

  else:
    signed_info_xml = PTN_SIGNED_INFO_XML_2 % {
      'xmlns_attr': xmlns_attr,
      'reference_uri': reference_uri,
      'digest_value': b64e(_digest(xml)),
    }

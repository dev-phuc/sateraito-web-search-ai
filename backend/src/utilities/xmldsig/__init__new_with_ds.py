...
RX_SIGNATURE = re.compile('<ds:Signature.*?</ds:Signature>')
RX_SIGNED_INFO = re.compile('<ds:SignedInfo.*?</ds:SignedInfo>')
RX_SIG_VALUE = re.compile('<ds:SignatureValue[^>]*>([^>]+)</ds:SignatureValue>')
...
PTN_SIGNED_INFO_XML = \
'<ds:SignedInfo%(xmlns_attr)s><ds:CanonicalizationMethod Algorithm="http://www.w3.org/2001/10/xml-exc-c14n#"></ds:CanonicalizationMethod><ds:SignatureMethod Algorithm="http://www.w3.org/2000/09/xmldsig#rsa-sha1"></ds:SignatureMethod><ds:Reference URI="%(reference_uri)s"><ds:Transforms><ds:Transform Algorithm="http://www.w3.org/2000/09/xmldsig#enveloped-signature"></ds:Transform><ds:Transform Algorithm="http://www.w3.org/2001/10/xml-exc-c14n#"><ec:InclusiveNamespaces xmlns:ec="http://www.w3.org/2001/10/xml-exc-c14n#" PrefixList="xs" /></ds:Transform></ds:Transforms><ds:DigestMethod Algorithm="http://www.w3.org/2000/09/xmldsig#sha1"></ds:DigestMethod><ds:DigestValue>%(digest_value)s</ds:DigestValue></ds:Reference></ds:SignedInfo>'
...
def sign(xml, f_private, key_info_xml, key_size, reference_uri='', sig_id_value=None):
  ...
  """
  signed_info_xml = _signed_info(xml, reference_uri)
...
def verify(xml, f_public, key_size, reference_uri=''):
  ...
  signed_info_xml = _signed_info(unsigned_xml, reference_uri)
...
def _get_xmlns_prefixes(xml):
  ...
  ns_attrs.append('xmlns:ds="http://www.w3.org/2000/09/xmldsig#"')
  return ' '.join(ns_attrs)


def _signed_info(xml, reference_uri=''):

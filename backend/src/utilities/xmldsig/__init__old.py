...
def sign(xml, f_private, key_info_xml, key_size, sig_id_value=None):
  ...
  #signed_xml = xml.replace('<saml2:Issuer Format="urn:oasis:names:tc:SAML:2.0:nameid-format:entity">', ''+signature_xml+'<saml2:Issuer Format="urn:oasis:names:tc:SAML:2.0:nameid-format:entity">', 1)
  return signed_xml

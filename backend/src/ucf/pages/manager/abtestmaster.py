...
## バリデーションチェッククラス 
############################################################
class ABTestMasterValidator(BaseValidator):
	u'''入力チェッククラス'''
	...
	def validate(self, helper, vo):
		...
		if self.total_count == 0:
			...
			models = UCFMDLABTestMaster.gql(gql)
...
## ビューヘルパー
############################################################
class ABTestMasterViewHelper(ViewHelper):

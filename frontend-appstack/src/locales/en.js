const ENGLISH_TRANSLATIONS = {
  translation: {
    ...
    TXT_TEXT_COLOR: "Choose the text color for search box content.",
    TXT_BUTTON_ICON_COLOR: "Color of the search button icon.",
    TXT_BUTTON_BG_COLOR: "Background color of the search button.",
    ...
    LABEL_SEARCH_DOMAIN_FILTER: "Allowed Domains",
    LABEL_EXCLUDED_DOMAIN_FILTER: "Blocked Domains",
    LABEL_ALLOWED_DOMAINS: "Allowed Domains ({{count}})",
    LABEL_BLOCKED_DOMAINS: "Blocked Domains ({{count}})",
    ...
    TXT_DOMAIN_FILTER_DESCRIPTION: "When enabled, the AI will only search within allowed domains and exclude blocked domains from search results.",
    TXT_SEARCH_DOMAIN_PLACEHOLDER: "Enter domain (e.g., example.com)",
    TXT_EXCLUDED_DOMAIN_PLACEHOLDER: "Enter domain to exclude (e.g., spam-site.com)",
    TXT_SEARCH_DOMAIN_HELP: "Add domains where the AI is allowed to search for information. Press Enter or click + to add.",
    TXT_EXCLUDED_DOMAIN_HELP: "Add domains that should be excluded from search results. Press Enter or click + to add.",
    TXT_NO_DOMAINS_ADDED: "No domains added yet",
    MSG_ERROR_DOMAIN_INVALID: "Please enter a valid domain format (e.g., example.com)",
    MSG_WARNING_DOMAIN_ALREADY_EXISTS: "This domain has already been added",
    MSG_SUCCESS_DOMAIN_ADDED: "Domain added successfully",
    MSG_INFO_DOMAIN_REMOVED: "Domain removed",
